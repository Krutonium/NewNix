...
let
  ...
  dotnetCombined = (with pkgs.dotnetCorePackages; combinePackages [ sdk_6_0 sdk_7_0 sdk_8_0 pkgs.master.dotnetCorePackages.sdk_9_0 ]).overrideAttrs (fineAttrs: previousAttrs: {
