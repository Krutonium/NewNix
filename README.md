...
In my flake, I am making use of 2 different modules to make everything smooth, one already mentioned:
 ...
 - [Import Tree](https://github.com/denful/import-tree), which in essence makes sure all .nix files within /enabled are in scope, without needing to explicitly import them.

With that combination, whenever I want to add a new module, be it a service, a desktop environment, or a system configuration, I can just add a new module to /enabled and it will automatically be picked up by flake-parts.
...
A guide to exploring my configuration can be found [here](./enabled/readme.md).
