...
let
  ...
  patch-vr = pkgs.writeShellScriptBin "patch-vr" ''
    ...
    #steam-run ~/.local/share/Steam/steamapps/common/SteamVR/bin/vrpathreg.sh adddriver ${pkgs.monado}/share/
 ...
 # }));
  ...
  rift_s_udev = pkgs.writeTextFile {
    ...
    text = ''
      ...
      #KERNEL=="hidraw*", ATTRS{idVendor}=="2833", MODE="0666", GROUP="users"
    ...
    '';
    destination = "/etc/udev/rules.d/70-xrhardware.rules";
  };
in
{
